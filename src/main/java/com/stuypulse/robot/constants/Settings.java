...
public interface Settings {
    ...
    public interface Intake { // TODO: Get all values for this
        Rotation2d PIVOT_STOW_ANGLE = Rotation2d.fromDegrees(0.0); 
        Rotation2d PIVOT_INTAKE_OUTAKE_ANGLE = Rotation2d.fromDegrees(90);

        public final Rotation2d PIVOT_ANGLE_TOLERANCE = Rotation2d.fromDegrees(0.1); 

        Rotation2d PIVOT_ANGLE_OFFSET = new Rotation2d();
        Rotation2d PIVOT_MAX_ANGLE = Rotation2d.fromDegrees(100);
        Rotation2d PIVOT_MIN_ANGLE = Rotation2d.fromDegrees(-10);
